...
int vmexit_amd(pcpuinfo currentcpuinfo, UINT64 *registers, void *fxsave UNUSED)
{
 ...
 // displayline("cpunr=%d\n", currentcpuinfo->cpunr);
  ...
  CONTEXT Context;
  Context.Rax = currentcpuinfo->vmcb->RAX;
  Context.Rbx = ((VMRegisters*)registers)->rbx;
  Context.Rcx = ((VMRegisters*)registers)->rcx;
  Context.Rdx = ((VMRegisters*)registers)->rdx;
  Context.Rsi = ((VMRegisters*)registers)->rsi;
  Context.Rdi = ((VMRegisters*)registers)->rdi;
  Context.Rsp = currentcpuinfo->vmcb->RSP;
  Context.Rbp = ((VMRegisters*)registers)->rbp;
  Context.R8  = ((VMRegisters*)registers)->r8;
  Context.R9  = ((VMRegisters*)registers)->r9;
  Context.R10 = ((VMRegisters*)registers)->r10;
  Context.R11 = ((VMRegisters*)registers)->r11;
  Context.R12 = ((VMRegisters*)registers)->r12;
  Context.R13 = ((VMRegisters*)registers)->r13;
  Context.R14 = ((VMRegisters*)registers)->r14;
  Context.R15 = ((VMRegisters*)registers)->r15;
  if(SVMExitBefore(currentcpuinfo->vmcb,&Context))
  {
    //store the registers back
    currentcpuinfo->vmcb->RAX = Context.Rax;
    ((VMRegisters*)registers)->rbx = Context.Rbx;
    ((VMRegisters*)registers)->rcx = Context.Rcx;
    ((VMRegisters*)registers)->rdx = Context.Rdx;
    ((VMRegisters*)registers)->rsi = Context.Rsi;
    ((VMRegisters*)registers)->rdi = Context.Rdi;
    currentcpuinfo->vmcb->RSP = Context.Rsp;
    ((VMRegisters*)registers)->rbp = Context.Rbp;
    ((VMRegisters*)registers)->r8  = Context.R8;
    ((VMRegisters*)registers)->r9  = Context.R9;
    ((VMRegisters*)registers)->r10 = Context.R10;
    ((VMRegisters*)registers)->r11 = Context.R11;
    ((VMRegisters*)registers)->r12 = Context.R12;
    ((VMRegisters*)registers)->r13 = Context.R13;
    ((VMRegisters*)registers)->r14 = Context.R14;
    ((VMRegisters*)registers)->r15 = Context.R15;

    result=0; //skip further handling
  }
  else
  {
    result=handleVMEvent_amd(currentcpuinfo, (VMRegisters*)registers, fxsave);
...
//  displayline("%d: %d:%x (%x,%x)                              \n",currentcpuinfo->cpunr,vmeventcount,vmread(vm_exit_reason),vmread(vm_guest_cs),vmread(vm_guest_rip));
  ...
  CONTEXT Context;
  Context.Rax = ((VMRegisters*)registers)->rax;
  Context.Rbx = ((VMRegisters*)registers)->rbx;
  Context.Rcx = ((VMRegisters*)registers)->rcx;
  Context.Rdx = ((VMRegisters*)registers)->rdx;
  Context.Rsi = ((VMRegisters*)registers)->rsi;
  Context.Rdi = ((VMRegisters*)registers)->rdi;
  Context.Rsp = vmread(vm_guest_rsp);
  Context.Rbp = ((VMRegisters*)registers)->rbp;
  Context.R8  = ((VMRegisters*)registers)->r8;
  Context.R9  = ((VMRegisters*)registers)->r9;
  Context.R10 = ((VMRegisters*)registers)->r10;
  ...
  Context.R14 = ((VMRegisters*)registers)->r14;
  Context.R15 = ((VMRegisters*)registers)->r15;
  if(VMXExitBefore(&Context))
  {
    ((VMRegisters*)registers)->rax = Context.Rax;
    ((VMRegisters*)registers)->rbx = Context.Rbx;
    ((VMRegisters*)registers)->rcx = Context.Rcx;
    ((VMRegisters*)registers)->rdx = Context.Rdx;
    ((VMRegisters*)registers)->rsi = Context.Rsi;
    ((VMRegisters*)registers)->rdi = Context.Rdi;
    vmwrite(vm_guest_rsp, Context.Rsp);
    ((VMRegisters*)registers)->rbp = Context.Rbp;
    ((VMRegisters*)registers)->r8  = Context.R8;
    ((VMRegisters*)registers)->r9  = Context.R9;
    ((VMRegisters*)registers)->r10 = Context.R10;
