...
#define VMCALL_CHANGE_PASSWORD 0x80000000
typedef struct
{
...
#define VMCALL_SET_PAGE_EXECUTE_PFN 0x80000001
typedef struct
{
    unsigned long long Pfn;
    unsigned long long ExecutePfn;
}SET_PAGE_EXECUTE_PFN_DATA;
#define VMCALL_GET_PAGE_EXECUTE_PFN 0x80000002
typedef struct
{
    unsigned long long Pfn;
    unsigned long long ExecutePfn;
}VMCALL_GET_PAGE_EXECUTE_PFN_DATA;
